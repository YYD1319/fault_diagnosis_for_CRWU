...
path_train = r'./cwt_picture/cmor3-3/train/'
path_test = r'./cwt_picture/cmor3-3/test/'


def cwt_trans(dataset_X, dataset_Y, save_path):
    list = [0] * 10
    time0 = time.time()
...
if __name__ == "__main__":
    cwt_trans(train_X, train_Y, path_train)
    cwt_trans(test_X, test_Y, path_test)
